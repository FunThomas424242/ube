...
import com.gh.funthomas424242.dsl.ube.ube.DataType;
import com.gh.funthomas424242.dsl.ube.ube.Entity;
import com.gh.funthomas424242.dsl.ube.ube.EntityModel;
import com.gh.funthomas424242.dsl.ube.ube.Feature;
import com.gh.funthomas424242.dsl.ube.ube.FeatureKind;
import com.gh.funthomas424242.dsl.ube.ube.NamedElement;
import com.gh.funthomas424242.dsl.ube.ube.Type;
import com.gh.funthomas424242.dsl.ube.ube.UbeFactory;
 ...
 * @generated
 */
public class UbePackageImpl extends EPackageImpl implements UbePackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.gh.funthomas424242.dsl.ube.ube.UbePackage#eNS_URI
   * @see #init()
   * @generated
   */
  private UbePackageImpl()
  {
    super(eNS_URI, UbeFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link UbePackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static UbePackage init()
  {
    if (isInited) return (UbePackage)EPackage.Registry.INSTANCE.getEPackage(UbePackage.eNS_URI);

    // Obtain or create and register package
    UbePackageImpl theUbePackage = (UbePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof UbePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new UbePackageImpl());

    isInited = true;

    // Create package meta-data objects
    theUbePackage.createPackageContents();

    // Initialize created meta-data
    theUbePackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theUbePackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(UbePackage.eNS_URI, theUbePackage);
    return theUbePackage;
  }
   ...
   * @generated
   */
  public UbeFactory getUbeFactory()
  {
    return (UbeFactory)getEFactoryInstance();
  }
